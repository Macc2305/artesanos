<?php
    ...
    $query = "SELECT ID_USUARIO, NOMBRE, CORREO, CONTRASEÑA, imagen FROM USUARIO";
    ...
    $query = "SELECT ID_USUARIO, NOMBRE, CORREO, CONTRASEÑA, imagen FROM USUARIO WHERE ID_USUARIO = 2";
        ...
        <?php while ($usuario = $resultado_usuarios->fetch_assoc()): ?> 
                ...
                <div class="card-body">
                        ...
                        <p class="card-text-des">
                            ...
                            <?php echo htmlspecialchars($usuario['CONTRASEÑA']); ?> 
                        </p>
                    </div>
        ...
        <?php while ($usuario_unico = $resultado_unico->fetch_assoc()): ?> 
            ...
            <div class="card"> 
                ...
                <div class="card-body">
                    ...
                    <p class="card-text-des">
                        <!-- Muestra el cargo -->
                        <?php echo htmlspecialchars($usuario_unico['CONTRASEÑA']); ?> 
                    </p>
                </div>
