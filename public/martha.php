<?php
    ...
    $query = "SELECT NOMBRE, imagen FROM USUARIO WHERE ID_USUARIO =3";
    ...
    $query = "SELECT HISTORIA FROM LOCAL WHERE ID_LOCAL = 3";
    ...
    $query = "SELECT NOMBRE_PRODUCTO, DESCRIPCION_PRODUCTO, IMAGEN_PRODUCTO FROM PRODUCTO WHERE ID_LOCAL = 3";
    // Preparamos la segunda consulta SQL
    $stmt = $conn->prepare($query);
    // Ejecutamos la segunda consulta preparada
    $stmt->execute();
